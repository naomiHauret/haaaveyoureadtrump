...
export default () => (state, actions) => {
  ...
  return <Page state={state} actions={actions} metaTitle={aboutMetaTitle} key={key}>
      <div class={cxs({
          flexGrow: 1,
          display: "flex",
        ...
        <div class={cxs({ position: "relative", width: `${6 / 12 * 100}%`,
            "@media (min-width: 1199px)": { width: `${4 / 12 * 100}%` }, "> p": { position: "absolute", transition: "all 450ms ease-in-out", margin: 0, fontSize: ds.pxTo(ds.get("typo.sizes.legend"), baseFontSize, "rem"), lineHeight: ds.pxTo(ds.get("typo.sizes.legend") + 4, baseFontSize, "rem") } })}>
          <p class={cxs({
              bottom: 0,
              right: 0,
            ...
            Born on June 14th, 1946 in<br /> New-York, son of Fred and<br /> Mary Anne Trump and<br /> brother of four other kids
          </p>
          <p class={cxs({
              bottom: 0,
              right: 0,
            ...
            First a realtor with his<br /> father, Donald also began<br /> the owner of several<br /> casinos, golf fields, football<br /> leagues, some beauty<br /> contests and, of course, of<br /> the Trump Tower.
          </p>
          <p class={cxs({
              left: 0,
              bottom: 0,
          ...
          <p class={cxs({
            ...
            Now at the head of a 3.1<br /> billion dollars fortune,<br /> Donald is the 248th richest<br /> man in the US, and the<br /> 766th on the world ranking
          </p>
